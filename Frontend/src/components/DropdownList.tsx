...
const DropdownList = <T,>({
  ...
  return (
    <div
      className={`mb-2 shadow-l collapse collapse-arrow dark:bg-gray-900  bg-gray-200 border border-base-300 ${isOpen ? "collapse-open" : "collapse-close"
        }`}
    >
      <div
      ...
      <div className="collapse-content text-sm">
        {allItems.length > 5 && (
          <input
            type="text"
            placeholder="Search"
            className=" bg-gray-200 dark:bg-gray-800 input input-bordered w-full mb-2"
            value={searchTerm}
