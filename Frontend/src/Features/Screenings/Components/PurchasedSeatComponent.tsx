            ...
            <Popover open={open} onOpenChange={setOpen}>
                <PopoverTrigger asChild>
                    <button
                        ...
                        className="w-10 h-10 rounded rounded-md  border rounded flex items-center justify-center cursor-pointer hover:bg-red-500 bg-yellow-700"
                    >
                ...
                <PopoverContent className="p-5 w-72 shadow-xl">
                    <div className="space-y-4">
                        <div className="font-medium">
                            Are you sure you want to remove this seat from the cart?
                        </div>
